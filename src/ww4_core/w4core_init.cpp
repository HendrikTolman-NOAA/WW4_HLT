...
void w4core_init(const ww4_utils::DateTime &startTime,
  ...
  try {
    ...
    //
    // 1.1 Process input (silent validation)
    //
    w4core_hom_input(os);
    ...
    if (globalRunConfig.produceStdOut) {
      ...
      os << "\n  Initialization (w4core_init) starting: "
         ...
         << std::endl;
      //
      // 0.4.4 Report out run time configuration (including homogeneous data)
      //
    ...
    if (globalRunConfig.produceLogFile) {
      ...
      logFile << "\n  Initialization (w4core_init) starting: "
              ...
              << std::endl;
      //
      // 0.5.5 Report out run time configuration (including homogeneous data)
      //
