 ...
 * @brief Implementation of NL2 nonlinear interaction source term calculations.
 * @details Concrete subroutine for NL2 nonlinear interaction source terms.
...
void SourceTermNL2::calculate(std::span<double> data) {
  std::for_each(data.begin(), data.end(), [](double &val) { val += 0.002; });
}
