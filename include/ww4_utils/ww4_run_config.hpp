...
struct RunConfig {
  ...
  std::vector<HomogeneousDataPoint>
      homogeneousWaterLevels; ///< Processed homogeneous water levels data.
  std::vector<HomogeneousDataPoint>
      homogeneousCurrents; ///< Processed homogeneous currents data.
  std::vector<HomogeneousDataPoint>
      homogeneousWinds; ///< Processed homogeneous winds data.
  std::vector<HomogeneousDataPoint>
      homogeneousIceConcentrations; ///< Processed homogeneous ice
                                    ///< concentrations data.
  std::vector<HomogeneousDataPoint>
      homogeneousBottomDepth; ///< Processed homogeneous bottom depth data.
