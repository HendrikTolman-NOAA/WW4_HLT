...
/**
 * @struct Dispersion
 * @brief Structure to hold wavenumber and group velocity.
 * @author Contributors: Jules (Agentic AI)
 * @date Initial, 2026-04-10
 */
struct Dispersion {
...
/**
 * @brief Calculate wavenumber and group velocity using Beji's (2013) formula.
 * @details Ported from WW3 routine WAVNU3 in w3dispmd.ftn.
 *          Based on the improved Eckart's formula by Beji (2013).
 ...
 * @return Dispersion struct containing wavenumber (k) and group velocity (cg).
 */
