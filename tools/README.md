...
For detailed compilation and setup instructions, please refer to the [Compilation and Environment Setup section in the main README](../README.md#compilation-and-environment-setup).
